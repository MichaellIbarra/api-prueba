...
class _UserslistScreenState extends State<UserslistScreen>
  ...
  void _searchUsers(String query) {
    List<dynamic> filteredList = users.where((user) {
    ...
    return GestureDetector(
      ...
      child: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text(
                "Lista de Usuarios ${isActive ? 'Activos' : 'Inactivos'}"),
            bottom: TabBar(
    ...
    if (confirmAction == true) {
      try {
        final response = await http.put(Uri.parse(
            'https://psychic-capybara-4xvq5g9x97j377v5-8085.app.github.dev/api/v1/users/$id/${estado ? 'inactivar' : 'restaurar'}'));
